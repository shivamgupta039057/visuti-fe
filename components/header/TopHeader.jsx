...
const TopHeader = () => {
  return (
    <div className="shadow-md z-10 relative bg-[linear-gradient(90deg,_rgba(9, 132, 147, 0.88)_0%,_rgba(32, 221, 142, 0.92)_100%)] overflow-hidden">
      {/* Background Image */}
      ...
      <div className="flex w-full items-center justify-between text-sm font-medium max-w-7xl mx-auto lg:px-6 px-4">
        ...
        {/* LEFT SECTION */}
        <div className="flex items-center gap-3 w-1/3 py-3">
        ...
        <div className="w-1/3 text-center py-2 text-black font-semibold   ">
          <Swiper
            ...
            loop={true}
          >
            <SwiperSlide className='text-sm'>India’s No.1 Medical Counselling Platform</SwiperSlide>
            <SwiperSlide className='text-sm'>Trusted by 10,000+ Students Worldwide</SwiperSlide>
            <SwiperSlide className='text-sm'>Get Personalized MBBS Admission Guidance</SwiperSlide>
          </Swiper>
        </div>

        {/* RIGHT SECTION */}
        <div className="flex items-center justify-end gap-3 w-1/3 px-6 py-3 text-white">
