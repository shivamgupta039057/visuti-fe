...
const Header = () => {
  ...
  return (
    <>
      <header
        id="mainHeader"
        className={`w-full z-[1010] bg-white transition-all duration-300 fixed top-0 left-0 ${isScrolled ? 'shadow-md' : 'shadow-none'
          }`}
      >
        <div
          className={`overflow-hidden transition-all duration-300 ${isScrolled ? 'max-h-0 opacity-0' : 'max-h-[100px] opacity-100'
            }`}
        >
          <TopHeader />
        </div>
        ...
        {/* bottom header  */}
        <div className={`bg-white border-b border-black/5 w-full max-lg:hidden overflowhidden transition-all duration-300 ${isScrolled ? 'max-h-0 opacity-0' : 'max-h-[60px] opacity-100'
          }`}>
                          ...
                          <div className="flex justify-between items-start gap-6">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="mt-6 grid grid-cols-1 gap-x-12 gap-y-3 text-accent text-sm">
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">college view</Link>
                                <Link href="/neetPredictor" className="hover:text-primary transition-colors">neet predictor</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">MBBS abroad</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">compare college</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">counseling notification</Link>
                                <Link href="/choicefillingmaker" className="hover:text-primary transition-colors">choice filling maker</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">document builder</Link>
                              </div>
                            </div>
                            {/* Right Ad Section */}
                            <div className="w-68">
                          ...
                          <div className="flex justify-between items-start gap-6">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="mt-6 grid grid-cols-2 capitalize gap-x-12 gap-y-3 text-accent text-sm">
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">russia</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">kazakhstan</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">georgia</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">uzbekistan</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">mauritius</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">nepal</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">bangladesh</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">kyrgystan</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">philippines</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">italy</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">germany</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">egypt</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">china</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">america</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">london</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">singapore</Link>
                              </div>
                            </div>
                            {/* Right Ad Section */}
                            <div className="w-68">
                          ...
                          <div className="flex justify-between items-start gap-6">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="grid grid-cols-1 capitalize gap-x-12 gap-y-3 text-accent text-sm">
                                ...
                                <Link href="/aboutUs" className="hover:text-primary transition-colors">about us</Link>
                                <Link href="/coming-soon" className="hover:text-primary transition-colors">FAQs</Link>
