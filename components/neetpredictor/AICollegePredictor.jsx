              ...
              <div className="bg-[#F7EBFF] h-full rounded-[10px] p-4 flex gap-3 items-start justify-center shadow-sm border border-[#2A3A2A]">
                  ...
                  <div className=" mb-3">
                      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path d="M24 18V24L28 26" stroke="#00FF88" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round"/>
                          <path d="M24 34C29.5228 34 34 29.5228 34 24C34 18.4772 29.5228 14 24 14C18.4772 14 14 18.4772 14 24C14 29.5228 18.4772 34 24 34Z" stroke="#00FF88" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
