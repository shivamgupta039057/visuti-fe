            ...
            <div className="relative z-10 max-sm:text-center">
              ...
              >
                <SwiperSlide>
                  ...
                  <Link href="/coming-soon" className="bg-white px-5 py-3 rounded-2xl font-medium md:text-lg text-sm inline-flex items-center gap-3 sm:mt-10 mt-5 max-sm:mx-auto hover:bg-gray-50 transition-colors">
                    Explore Colleges
                ...
                <SwiperSlide>
                  ...
                  <Link href="/neetpredictor" className="bg-white px-5 py-3 rounded-2xl font-medium md:text-lg text-sm inline-flex items-center gap-3 sm:mt-10 mt-5 max-sm:mx-auto hover:bg-gray-50 transition-colors">
                    Try Predictor
                    <Image src="/arrowrightblack.png" alt="arrow" width={18} height={18} />
                  </Link>
                </SwiperSlide>
