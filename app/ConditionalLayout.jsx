      ...
      {!isDashboard && !isComingSoon && (
        <div className="fixed right-6 bottom-6 z-[999999]">
          <a
            ...
            target="_blank"
            className="relative ripple sm:w-[60px] w-12 sm:h-[60px] h-12 flex items-center justify-center bg-green-600 text-white rounded-full shadow-lg"
          >
            <svg
              stroke="currentColor"
              fill="currentColor"
            ...
            >
              <path
                d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 
        99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 
